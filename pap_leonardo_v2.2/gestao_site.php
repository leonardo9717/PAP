...
<hr>
<p>Aqui pode apagar todos os registo site, como também criar contas de administrador.</p>
<h3></h3>

<form method="post" action="eliminar_todos_nao_inscritos.php">
<button type="submit"  class="button alert radius" onclick="return confirm('Tem a certeza que deseja eliminar todos os alunos que não estão inscritos?')">Eliminar alunos ainda não inscritos</button><br>
</form>
<form method="post" action="eliminar_todos_inscritos.php">
<button type="submit" class="button alert radius" onclick="return confirm('Tem a certeza que deseja eliminar todos os alunos que estão inscritos?')">Eliminar alunos inscritos</button><br>
</form>
<form method="post" action="eliminar_horarios_modalidades.php">
<button type="submit" class="button alert radius" onclick="return confirm('Tem a certeza que deseja eliminar todas as modalidades e horários atribuidos?')">Eliminar Horários e Modalidades</button><br>
</form>
<form method="post" action="eliminar_todos_registos.php">
<button type="submit" class="button alert radius" onclick="return confirm('Tem a certeza que deseja eliminar todos os registos?')">Eliminar todos os registos</button><br>
</form>
<hr>
<a href="criar_contas.php" class="button radius">Criar Contas de Admin</a><br>
