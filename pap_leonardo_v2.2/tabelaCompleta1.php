...
<?php 
        ...
        $result = "SELECT nome_aluno,n_processo,ano,turma,n_turma,modalidade,autorizacao,EE,CCEE,telefone,telemovel,nascimento,telefonee,escalao,data_inscricao FROM inscricao_alunos WHERE inscrito=0 ORDER BY modalidade ASC,n_processo ASC";
